...
var style_ADMINISTRASIKECAMATAN_AR_25K_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Jumlah Kepadatan Penduduk");
    var labelText = "";
    size = 0;
    ...
    if (value >= 7733.000000 && value <= 10690.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10690.000000 && value <= 10714.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 10714.000000 && value <= 13992.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 13992.000000 && value <= 17499.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17499.000000 && value <= 25844.000000) {
            style = [ new ol.style.Style({

...
.link a{
    ...
    <div class="cont1">
        ...
        <div class="intro">
           <br><p>DATA KEPADATAN PENDUDUK<br> KOTA ADMINISTRASI JAKARTA UTARA</p>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                include "koneksi.php";
                $sql = "SELECT * FROM kepadatan";
                $query = mysqli_query($conn, $sql);

                while($data = mysqli_fetch_array($query)){
                ?>
                <tr>
                    <th><?php echo $data['provinsi']; ?></th>
                    <td><?php echo $data['kota']; ?></td>
                    <td><?php echo $data['kecamatan']; ?></td>
                    <td><?php echo $data['jml']; ?></td>
                    <td><a href="edit.php?jml=<?php echo $data['jml']; ?>">EDIT DATA</a></td>
                </tr>
                <?php
        ...
        <div class="pembungkusmap">
            <div class="link">
                <img src="img/edit.jpg" width=50px height=50px alt="Logo Edit">&ensp;<a href="edit.php?id=<?php echo $d['id']; ?>">EDIT DATA</a>
        </div>
        <div id="map">

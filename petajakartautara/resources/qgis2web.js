...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_ADMINISTRASIKECAMATAN_AR_25K_0,
      colName: 'Jumlah Kepadatan Penduduk',
      zoom: 10,
      collapsed: true,
      map: map
    });
...
map.getView().fit([11878441.435684, -691665.808773, 11909226.511084, -675851.976323], map.getSize());
